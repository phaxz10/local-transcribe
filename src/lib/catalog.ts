...
const ENTRIES: Entry[] = [
  ...
  { id: 'parakeet-en', label: 'Parakeet (English)', task: 'transcription', family: 'parakeet-ctc', hfId: 'onnx-community/parakeet-ctc-0.6b-ONNX', englishOnly: true, multilingual: false, sizeMb: 612, ramCeilingMb: 1250, requiresWebGPU: false, timestamps: 'word', languages: { en: 3 } },
